...
declare const SkeletonContainer: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface SkeletonProps extends ComponentProps<typeof SkeletonContainer> {
    variant: string;
    size: string;
}
...
declare function Toast({ title, description, type, onClose, }: ToastProps): react_jsx_runtime.JSX.Element;
...
declare const theme: string & {
    ...
    colors: {
        ...
        lime100: _stitches_react_types_theme.Token<"lime100", string, "colors", "">;
        lime200: _stitches_react_types_theme.Token<"lime200", string, "colors", "">;
        lime300: _stitches_react_types_theme.Token<"lime300", string, "colors", "">;
        lime400: _stitches_react_types_theme.Token<"lime400", string, "colors", "">;
        lime500: _stitches_react_types_theme.Token<"lime500", string, "colors", "">;
        lime600: _stitches_react_types_theme.Token<"lime600", string, "colors", "">;
        lime700: _stitches_react_types_theme.Token<"lime700", string, "colors", "">;
        lime800: _stitches_react_types_theme.Token<"lime800", string, "colors", "">;
        lime900: _stitches_react_types_theme.Token<"lime900", string, "colors", "">;
        ...
        red400: _stitches_react_types_theme.Token<"red400", string, "colors", "">;
        red500: _stitches_react_types_theme.Token<"red500", string, "colors", "">;
        red600: _stitches_react_types_theme.Token<"red600", string, "colors", "">;
        red700: _stitches_react_types_theme.Token<"red700", string, "colors", "">;
        red800: _stitches_react_types_theme.Token<"red800", string, "colors", "">;
        red900: _stitches_react_types_theme.Token<"red900", string, "colors", "">;
    };
    fontSizes: {
    ...
    fonts: {
        ...
        paragraph: _stitches_react_types_theme.Token<"paragraph", string, "fonts", "">;
        title: _stitches_react_types_theme.Token<"title", string, "fonts", "">;
    ...
    boxShadow: {
        none: _stitches_react_types_theme.Token<"none", string, "boxShadow", "">;
        sm: _stitches_react_types_theme.Token<"sm", string, "boxShadow", "">;
        md: _stitches_react_types_theme.Token<"md", string, "boxShadow", "">;
        lg: _stitches_react_types_theme.Token<"lg", string, "boxShadow", "">;
        xl: _stitches_react_types_theme.Token<"xl", string, "boxShadow", "">;
        '2xl': _stitches_react_types_theme.Token<"2xl", string, "boxShadow", "">;
        inner: _stitches_react_types_theme.Token<"inner", string, "boxShadow", "">;
    };
    opacity: {
        0: _stitches_react_types_theme.Token<"0", string, "opacity", "">;
        25: _stitches_react_types_theme.Token<"25", string, "opacity", "">;
        50: _stitches_react_types_theme.Token<"50", string, "opacity", "">;
        75: _stitches_react_types_theme.Token<"75", string, "opacity", "">;
        100: _stitches_react_types_theme.Token<"100", string, "opacity", "">;
    };
};
declare const createTheme: <Argument0 extends string | ({
    ...
    fonts?: {
        ...
        paragraph?: string | number | boolean | undefined;
    ...
    opacity?: {
        ...
        75?: string | number | boolean | undefined;
...
export { Avatar, type AvatarProps, Box, type BoxProps, Button, type ButtonProps, Checkbox, type CheckboxProps, Heading, type HeadingProps, MultiStep, type MultiStepProps, Skeleton, type SkeletonProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps, Toast, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
